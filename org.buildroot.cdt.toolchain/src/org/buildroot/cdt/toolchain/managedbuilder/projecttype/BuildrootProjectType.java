 ...
 * id="com.analog.gnu.toolchain.blackfin.target.bfin.elf.exe" isAbstract="false"
 * isTest="false"> <configuration buildProperties=
 ...
 * name="%ConfigName.Rel" parent="cdt.managedbuild.config.gnu.base"> <toolChain
...
public class BuildrootProjectType extends BuildrootConfigElement {
	 ...
	 * Build artefact type.
	 */
	private BuildArtefactType buildArtefactType;
	...
	public String getAttribute(String attribute) {
		if ("buildArtefactType".equals(attribute)) {
			return "org.eclipse.cdt.build.core.buildArtefactType."+buildArtefactType.getValue();
